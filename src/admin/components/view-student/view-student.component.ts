...
export class ViewStudentComponent {
    ...
    searchStudent(): void {
        if (this.searchString.length > 2) {
            this.adminService.searchStudent(this.searchString)
    ...
    selectedStudent(id: any): void {
        this.searchResponse = null;

        this.createForm();

        this.adminService.getStudentInfo(id)
        .takeWhile(() => this.alive)
        .subscribe(
            response => {
                ...
                this.studentForm.get('id').setValue(id);
    ...
    saveStudentInfo() {
        ...
        this.adminService.updateStudentInfo(this.studentForm.value['id'], temp)
        .takeWhile(() => this.alive)
        .subscribe(
            response => {

                this.successMessage = 'Student was updated successfully!';
            },
            error =>  {
